...
## Project Structure
    ...
    ├── testapiautocatalog_112259  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_112259`
...
2. Clone this repo and `cd testapiautocatalog_112259`
